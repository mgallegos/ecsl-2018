...
<div class="row">
  <div class="col-xl-3 col-lg-4 col-12 mb-3">
    ...
    <ul class="list-group dashboard-list-group">
      ...
      <a id="dash-transporte-from" href="#" class="list-group-item">Solicitar transporte desde <i class="fa fa-plane"></i> / <i class="fa fa-bus"></i></a>
      <a id="dash-transporte-to" href="#" class="list-group-item">Solicitar transporte hacia <i class="fa fa-plane"></i> / <i class="fa fa-bus"></i></a>
